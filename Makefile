...
CMAKE_FLAGS := -DCMAKE_BUILD_TYPE=$(OPT) -DCMAKE_INSTALL_LIBDIR=$(LIB_INSTALL) -DCMAKE_INSTALL_INCLUDEDIR=$(HEADER_INSTALL) -DCI=$(CI)

MAKE_FLAGS := -j $(shell sysctl -n hw.logicalcpu)
