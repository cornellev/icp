...
void test_icp_generic(const std::string& method, const icp::ICP::Config& config) {
    ...
    // Test case 1: Single point translation
    {
        ...
        std::cout << "[1]Result Transform Translation Y: " << result.transform.translation.y() << std::endl;
...
//need more test case that works for trimmed and feature aware(more points? since it filtered out points)
    {
        // Translation + rotation
        std::vector<icp::Vector> a = {icp::Vector(0, 0), icp::Vector(100, 0)};
        std::vector<icp::Vector> b;
        ...
        std::cout << "[4]Result Transform Translation X: " << result.transform.translation.x() << std::endl;
        std::cout << "[4]Result Transform Translation Y: " << result.transform.translation.y() << std::endl;
...

    {
        ...
        std::normal_distribution<double> noise_dist(0.0, 1.0); // Noise with standard deviation of 1.0
